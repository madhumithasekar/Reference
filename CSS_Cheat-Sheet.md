...
After giving float:left then it would look like this but see the yellow box also has moved to the right side. To resolve such issue use clearfix property shown below
